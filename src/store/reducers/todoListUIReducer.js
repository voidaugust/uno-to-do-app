...
export default function todoListUIReducer(state = todoListUIInitialState, {type, payload}) {
  switch (type) {
    ...
    case TOGGLE_SHOWING_IMPORTANT: return { ...state, showingImportant: !state.showingImportant }
    
    case SET_ACTIVE_LIST_ID: return { ...state, activeListId: payload.listId }
